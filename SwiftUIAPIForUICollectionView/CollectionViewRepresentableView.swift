//
//  CollectionViewRepresentableView.swift
...
/// The underlying SwiftUI View that manages the UICollectionView and its layout.
struct CollectionViewRepresentableView<Data, CellContent> where Data: RandomAccessCollection, Data.Element: Identifiable, CellContent: View {
    ...
    // MARK: Initializers
    /// Initializes a` CollectionViewRepresentableView` using a collection of identified data and a cell content provider.
    /// - Parameters:
    ...
    public init(_ data: Data, widthDimension: FlowLayoutDimension, heightDimension: FlowLayoutDimension, @ViewBuilder cellContentProvider: @escaping (Data.Element) -> CellContent) {
        self.data = data
